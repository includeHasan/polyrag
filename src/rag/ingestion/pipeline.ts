...
import { parseSections, type ParsedSection } from "@/rag/processing/parse.js";
import { IngestionError } from "@/core/shared/errors.js";
import { logger } from "@/core/shared/logger.js";
import type { Chunk, Document, IngestRequest, Source } from "@/core/shared/types.js";
...
export async function runIngestion(request: IngestRequest): Promise<IngestionResult> {
  ...
  try {
    const { getBM25Index } = await import("@/rag/retrieval/bm25Index.js");
